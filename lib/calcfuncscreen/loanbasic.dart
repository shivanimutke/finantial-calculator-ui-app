...
class loanbasic extends StatefulWidget {
...
class _SIFormState extends State<loanbasic> {
...
/**/
  ...
  TextEditingController termMController = TextEditingController();
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => FoodForm()));
        },
